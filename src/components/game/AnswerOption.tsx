  ...
  return (
    <button
      ...
      className={`
        ...
        ${
          state === "default"
            ? "bg-white border-[#E8E8E8] hover:border-[#FF6B35] hover:shadow-md hover:-translate-y-0.5 cursor-pointer"
            : ""
        }
        ...
        ${
          state === "disabled"
            ? "bg-[#F9F9F9] border-[#E8E8E8] opacity-50 cursor-not-allowed"
            : ""
        }
      `}
    >
      ...
      `}
        style={
          state === "default" || state === "disabled"
            ? {
                background: state === "disabled" ? "#D9D9D9" : lc.bg,
                color: lc.text,
              }
            : { color: "white" }
        }
