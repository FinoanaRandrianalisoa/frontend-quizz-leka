...
export default function SettingsPage({
  ...
  const handleLocalImage = (
    ...
    reader.onload = () => {
      ...
      setProfile((p) => ({
        ...p,
        [target === "profil" ? "photoProfil" : "photoCouverture"]: result,
      }))
    }
    ...
    <div className="max-w-2xl mx-auto px-4 md:px-6 py-6 pb-20 md:pb-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-[#A0A0A0]">
          Personnalisez votre expérience Quizz Leka
        </p>
      </div>
        ...
        <TabsContent value="profile" className="mt-5 flex flex-col gap-4">
          <Card>
            <CardContent className="p-5 flex flex-col gap-4">
              ...
              <Input
                ...
                onChange={(e) =>
                  setProfile((p) => ({ ...p, pseudo: e.target.value }))
                }
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <Input
                  ...
                  onChange={(e) =>
                    setProfile((p) => ({ ...p, dateNaissance: e.target.value }))
                  }
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-3">
                    {user?.photoCouverture && !profile.photoCouverture ? (
                      <img
                        src={user.photoCouverture}
                        alt="Photo couverture"
                        className="h-16 w-28 object-cover rounded-xl border border-[#D9D9D9]"
                      />
                    ...
                    <label className="inline-flex items-center gap-2 cursor-pointer rounded-lg border border-[#D9D9D9] px-3 py-2 text-sm text-[#2D3142] hover:bg-[#F9F9F9]">
                      ...
                      <input
                        ...
                        accept="image/*"
                        className="hidden"
                        onChange={(e) => handleLocalImage(e, "couverture")}
                      />
                    </label>
                  </div>
                </div>
          ...
          <Card>
            <CardContent className="p-5">
              <h3 className="font-semibold text-[#2D3142] mb-1">
                Zone de danger
              </h3>
              ...
              {[
                {
                  ...
                  desc: "Recevoir des notifications de parties et défis",
                },
                {
                  key: "emailNotifs",
                  icon: Bell,
                  label: "Notifications email",
                  desc: "Résumé hebdomadaire et alertes importantes",
                },
                {
                  key: "gameInvites",
                  icon: User,
                  label: "Invitations de jeu",
                  desc: "Être notifié quand quelqu'un vous défie",
                },
                {
                  key: "sounds",
                  icon: Volume2,
                  label: "Sons du jeu",
                  desc: "Sons de réponse, timer et victoire",
                },
              ...
              {[
                {
                  ...
                  icon: Globe,
                  label: "Profil public",
                  desc: "Votre profil est visible par tous les joueurs",
                },
                {
                  key: "darkMode",
                  icon: Moon,
                  label: "Mode sombre",
                  desc: "Interface sombre pour jouer la nuit",
                },
              ].map(({ key, icon: Icon, label, desc }, i, arr) => (
                <div key={key}>
                  <div className="flex items-center gap-3 py-3">
